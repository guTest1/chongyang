...
<title>${view.title} - 上海重阳投资管理股份有限公司</title>
				...
				<tr>
					<td>
                    	<table width="625" border="0" cellspacing="0" cellpadding="0">
                        	<tr>
                            	<td>
                                	<strong style="color: #0F3653; font-weight: bolder"><e:if test="${view.author!=null}">${view.author}：</e:if>${view.title}</strong>&nbsp;${view.releasedate} ${view.releasetime}&nbsp;&nbsp;
                                </td>
                        	</tr>
                        	<tr>
	                            <td style="color: #7b7b7b">
	                                <br/>
	                                <e:if test="${view.author!=null}">
